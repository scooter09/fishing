...
<table align="center">
	...
	<tr>
		...
		<td width="400" align="left">
			...
			<option value="100">문학도서</option>
			<option value="200">외국어도서</option>
			<option value="300">컴퓨터도서</option>
			<option value="400">낚시도서</option>
			<option value="500">여행도서</option>
			</select>
		</td>
	</tr>
